 ...
 */
export const fold = /*#__PURE__*/ Transition.define(function (el, options = {}) {
    ...
    let paddingProp1 = direction === 'vertical' ? 'paddingTop' : 'paddingLeft';
    let paddingProp2 = direction === 'vertical' ? 'paddingBottom' : 'paddingRight';
    ...
    let marginProp1 = direction === 'vertical' ? 'marginTop' : 'marginLeft';
    let marginProp2 = direction === 'vertical' ? 'marginBottom' : 'marginRight';
    let o = {
        startFrame: {
            [prop]: '0',
            [paddingProp1]: '0',
    ...
    return assignWithoutKeys(o, options, ['direction', 'fade']);
});
