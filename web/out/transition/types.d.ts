 ...
 */
export type TransitionAbleValue = CompositeOf<TransitionAbleValueBase> | CompositeOf<CompositeOf<TransitionAbleValueBase>> | CompositeOf<CompositeOf<CompositeOf<TransitionAbleValueBase>>>;
...
export type Mixable<T> = {
    mix(v: T, rate: number): T;
};
